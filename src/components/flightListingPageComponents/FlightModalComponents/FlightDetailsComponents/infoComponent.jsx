const InfoAlert = ({ city, time }) => {
  return (
    <div className="flex justify-between items-center bg-[#F3F4F6FF] py-[9px] px-6 rounded-[22px]">
      <div className="flex items-center gap-3">
        ...
        <p className="text-[#171A1FFF] font-normal text-base ">
          Stop to change planes in <span className="font-semibold">{city}</span>
        </p>
      </div>
      <span className="text-[#171A1FFF] font-semibold">{time}</span>
    </div>
  );
};
